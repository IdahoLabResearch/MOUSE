...
# **************************************************************************************************************************  
for params['Packing Factor'] in np.linspace(0.34, 0.44, 4):
    print("\n\n\n",params['Packing Factor'], "PACKING FRACTION", "\n\n\n")
    update_params({
        # fuel pin details
    ...
    parametric_studies('cost/Cost_Database.xlsx',  params, tracked_params_list, 'output_parametric_CGMR_packing_fraction_3.csv')
