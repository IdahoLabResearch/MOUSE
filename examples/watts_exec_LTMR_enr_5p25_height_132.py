...
update_params({
    ...
    'TRISO Fueled': "No",
    'Fuel': 'UO2',
    'Enrichment': 0.0525,  # Fraction between 0 and 1
    'Coolant': 'NaK',
...
params['Active Height'] = 132.0  # cm, explicit
params['Shutdown Rod Height'] = 132.0  # cm, explicit
...
update_params({
    ...
    'Drum Height': 221.0799973452091,  # cm, explicit
