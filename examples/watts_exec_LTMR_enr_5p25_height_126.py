...
params['Active Height'] = 126.0  # cm, explicit
params['Shutdown Rod Height'] = 126.0  # cm, explicit
...
update_params({
    ...
    'Drum Height': 215.0799973452091,  # cm, explicit
