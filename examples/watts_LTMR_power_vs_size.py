...
# **************************************************************************************************************************  
for params['Number of Rings per Assembly'] in [ 8, 9, 10, 11, 12]:
    update_params({
    ...
    params['Reflector Thickness'] = 0.357 * params['Lattice Radius']
    ...
    update_params({
        'Drum Radius': 0.643 * params['Reflector Thickness'],  # cm
    ...
    # ************************************************************************************************************************** 
    if params['Number of Rings per Assembly'] == 8:
        params['Power MWt'] = 4
    elif params['Number of Rings per Assembly'] == 9:
        params['Power MWt'] = 8
    elif params['Number of Rings per Assembly'] == 10:
        params['Power MWt'] = 12
    elif params['Number of Rings per Assembly'] == 11:
        params['Power MWt'] = 16
    elif params['Number of Rings per Assembly'] == 12:
        params['Power MWt'] = 20
    ...
    tracked_params_list =     ['Power MWt', 'Number of Rings per Assembly', 'Heat Flux','Drum Radius', "Core Radius",'Drum Absorber Thickness', "Fuel Lifetime", "Mass U235", "Mass U238", "Uranium Mass"]

    parametric_studies('cost/Cost_Database.xlsx',  params, tracked_params_list, 'output_parametric_smaller_power_bigger_core.csv')
