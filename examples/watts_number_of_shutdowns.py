...
#                                           Sec. 9: Operation
# **************************************************************************************************************************
for params['Operation Mode'] in ["Autonomous", "Non-Autonomous"]:
    for params['Emergency Shutdowns Per Year'] in np.linspace(0.2, 2, 7):
        update_params({
        ...
        tracked_params_list =     ['Operation Mode', 'Emergency Shutdowns Per Year', 'Heat Flux', "Fuel Lifetime",'Capacity Factor', 'FTEs Per Onsite Operator Per Year']

        parametric_studies('cost/Cost_Database.xlsx',  params, tracked_params_list, 'output_emergency_shutdowns.csv')
